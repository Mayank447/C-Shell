...
shell: shell.o history.o find.o color.o ls.o input_handling.o path_handling.o bg_process.o
	gcc -o shell shell.o bg_process.o color.o find.o history.o ls.o input_handling.o path_handling.o 
